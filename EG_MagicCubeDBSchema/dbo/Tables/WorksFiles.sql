CREATE TABLE [dbo].[WorksFiles](
	...
	[FileBase64Str] [varchar](max) NOT NULL,
...
GO
EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'base64檔案編碼字串' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'WorksFiles', @level2type=N'COLUMN',@level2name=N'FileBase64Str'