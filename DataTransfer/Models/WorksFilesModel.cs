...
namespace EG_MagicCube.Models
{
    public class WorksFilesModel
    {
        ...
        /// <returns></returns>
        public bool InsFile(List<byte[]> UploadWorksFiles)
        {
        ...
        /// <returns></returns>
        public bool InsFile(byte[] UploadWorksFile)
        {
            bool IsIns = InsFile(this.WorksNo, new List<byte[]>() { UploadWorksFile });
            GetFileList();
            return IsIns;
        }
        /// <summary>
        ...
        /// <param name="UploadWorksFile">http檔案</param>
        /// <returns></returns>
        public static bool InsFile(string WorksNo, byte[] UploadWorksFile)
        {
            return InsFile(WorksNo, new List<byte[]>() { UploadWorksFile });
        }
